...
makeConfig() {
	...
	echo "---------------"
	read -p "Link website: https://dilys.dev/"
	echo "---------------"
  ...
  -
    ...
    ControllerConfig:
      ...
      CertConfig:
        ...
        CertFile: /etc/XrayR/texpn/crt.sh 
        KeyFile: /etc/XrayR/texpn/key.sh
        Provider: alidns 
        Email: test@me.com
        DNSEnv: 
...
EOF
	cd /etc/XrayR
	git clone https://github.com/danghoang1/texpn.git
	XrayR restart
